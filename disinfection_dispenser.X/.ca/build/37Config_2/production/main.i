...
# 57 "main.c"
        while(DispenserOn){
            ...
            Dio_Pin_Write (4,1);
            Counter = 1 + ((uint32)89*Adc_ReadResult()/1024);
            for(;(Counter>0)&&DispenserOn;Counter--){
                _delay((unsigned long)((800)*(4000000/4000.0)));
                MAX7219_DisplayData(0x04, MAX7219_No_Table[Counter/600]);
                MAX7219_DisplayData(0x03, MAX7219_No_Table[(Counter/60)%10]);
                MAX7219_DisplayData(0x02, MAX7219_No_Table[(Counter%60)/10]);
                MAX7219_DisplayData(0x01, MAX7219_No_Table[(Counter%60)%10]);
            }
            Dio_Pin_Write (4, 0);
            DispenserOn=0;
