...
//uncomment one of the following lines by default adc is gonna be left adjusted
#define ADC_FORMAT_HIGH   // SET ADFM = 0 DEFAULT
//#define ADC_FORMAT_LOW    // SET ADFM = 1



//Choose the analog pins u need (Hint) the pins must be configured as analog in GPIO cfg ALSO
#define ADC_PIN0_AN0           // Analog Input AN0 (for PIC12F675 only)
//#define ADC_PIN1_AN1           // Analog Input AN1 (for PIC12F675 only)
//#define ADC_PIN2_AN2          // Analog Input AN2 (for PIC12F675 only)
//#define ADC_PIN4_AN3          // Analog Input AN3 (for PIC12F675 only)
...
#define SET_ADC_CONVERSION_SPEED_FASTEST(xtalFreq_Hz) \
    (ANSEL &= ~(0b111 << 4) );\
