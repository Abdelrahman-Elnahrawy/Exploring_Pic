...
volatile unsigned char previous_gp3_state = 0;
...
void __attribute__((picinterrupt(("")))) ISR() {
    ...
    if (INTCONbits.GPIF) {
        ...
        if ((GPIO & (1 << 3)) && !previous_gp3_state) {

            MAX7219_DisplayNumber(1000);

        }


        previous_gp3_state = (GPIO & (1 << 3)) ? 1 : 0;
