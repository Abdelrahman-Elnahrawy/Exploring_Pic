...
# 1 "./MCAL/include/gpio.h" 1
# 17 "./MCAL/include/gpio.h"
# 1 "./MCAL/include/../cfg/Gpio_Cfg.h" 1
# 17 "./MCAL/include/../cfg/Gpio_Cfg.h"
# 1 "./MCAL/cfg/../../UTILS/Std_Types.h" 1
# 15 "./MCAL/cfg/../../UTILS/Std_Types.h"
...
# 17 "./MCAL/include/../cfg/Gpio_Cfg.h" 2

# 1 "./MCAL/cfg/../include/Gpio_Types.h" 1
# 18 "./MCAL/include/../cfg/Gpio_Cfg.h" 2
# 67 "./MCAL/include/../cfg/Gpio_Cfg.h"
typedef struct {
    uint8 pinNumber;
    uint8 PinDirection;
    uint8 StateType;
...
# 1 "./MCAL/include/Adc.h" 1
# 19 "./MCAL/include/Adc.h"
# 1 "./MCAL/include/../include/Adc_Types.h" 1
# 21 "./MCAL/include/../include/Adc_Types.h"
typedef enum {
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
# 19 "./MCAL/include/Adc.h" 2

# 1 "./MCAL/include/../cfg/Adc_Cfg.h" 1
# 20 "./MCAL/include/Adc.h" 2
...
# 1 "./MCAL/include/Dio.h" 1
# 20 "./MCAL/include/Dio.h"
# 1 "./MCAL/include/../include/Dio_Types.h" 1
# 20 "./MCAL/include/Dio.h" 2
...
# 1 "./SERVICE/include/Spi.h" 1




# 1 "./SERVICE/include/../cfg/Spi_Cfg.h" 1
# 5 "./SERVICE/include/Spi.h" 2
...
# 1 "./HAL/include/max7219.h" 1
# 58 "./HAL/include/max7219.h"
...
int main (void){
   ...
   IOCB |= (1 << 3);
    ...
    while (1){
        ...
        while(DispenserOn){
            Adc_StartConversion(ADC_CHANNEL_AN0);

            MAX7219_ClearDisplay(); MAX7219_DisplayData(0x04,0x1D); MAX7219_DisplayData(0x03,0x15);;


            for(uint8 i=0; (i<100)&&DispenserOn;i++ )
            ...
            Counter = 10*(5 + (2*Adc_ReadResult()/1020));

            for(;(Counter>0)&&DispenserOn;Counter--){
                MAX7219_DisplayData(0x04, MAX7219_No_Table[Counter/6000]);
                MAX7219_DisplayData(0x03, MAX7219_No_Table[(Counter/600)%10]);
                MAX7219_DisplayData(0x02, MAX7219_No_Table[((Counter/10)%60)/10]);
                MAX7219_DisplayData(0x01, MAX7219_No_Table[((Counter/10)%60)%10]);
                _delay((unsigned long)((98)*(4000000/4000.0)));
            }
            Dio_Pin_Write (4, 0);
            DispenserOn=0;
            MAX7219_ClearDisplay(); MAX7219_DisplayData(0x05,0x1D); MAX7219_DisplayData(0x04,0x47); MAX7219_DisplayData(0x03,0x47);;
        }
    }
