...
# 2 "<built-in>" 2
# 1 "HAL/scr/max7219.c" 2
# 1 "HAL/scr/../include/max7219.h" 1
...
# 4 "HAL/scr/../include/max7219.h" 2


# 1 "HAL/scr/../include/../../UTILS/Std_Types.h" 1
# 15 "HAL/scr/../include/../../UTILS/Std_Types.h"
...
# 6 "HAL/scr/../include/max7219.h" 2
# 55 "HAL/scr/../include/max7219.h"
...
# 1 "HAL/scr/../../SERVICE/include/Spi.h" 1




# 1 "HAL/scr/../../SERVICE/include/../cfg/Spi_Cfg.h" 1
...
# 1 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/Gpio_Cfg.h" 1
# 18 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/Gpio_Cfg.h"
# 1 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/../include/Gpio_Types.h" 1
# 18 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/Gpio_Cfg.h" 2
# 67 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/Gpio_Cfg.h"
typedef struct {
    uint8 pinNumber;
    uint8 PinDirection;
    uint8 StateType;
...
# 8 "HAL/scr/../../SERVICE/include/../cfg/Spi_Cfg.h" 2



# 1 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/efuse.h" 1
# 25 "HAL/scr/../../SERVICE/include/../cfg/../../MCAL/cfg/efuse.h"
...
# 11 "HAL/scr/../../SERVICE/include/../cfg/Spi_Cfg.h" 2
# 5 "HAL/scr/../../SERVICE/include/Spi.h" 2
...
void MAX7219_Init(void) {
    SPI_Send_16bit(0x0900);
    SPI_Send_16bit(0x0A0F);
    SPI_Send_16bit(0xFBF7);
...
void MAX7219_DisplayNumber(uint32_t number) {
        for (uint8_t i = 0; i < 8; i++) {
            MAX7219_DisplayData(0x01 +i, MAX7219_No_Table[number % 10]);
            number /= 10;
        }
    }
...
void MAX7219_Shutdown(uint8_t state) {
    SPI_Send_16bit((0x0C << 8) | (state ? 0x01 : 0x00));
}
